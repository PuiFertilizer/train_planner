      ...
      children: <Widget>[
          ...
          child: new ListView.builder(
              ...
              itemBuilder: (BuildContext context, int index) {
                ...
                return Stack(
                  children: <Widget>[
                    Container(
                      margin: EdgeInsets.fromLTRB(40.0, 20.0, 40.0, 5.0),
                      height: 170.0,
                      ...
                      child: Padding(
                        padding:
                            const EdgeInsets.fromLTRB(10.0, 10.0, 110.0, 10.0),
                        child: Column(
        ...
        ElevatedButton.icon(
          onPressed: () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => Writeplan()),
            );
          },
          icon: Icon(Icons.add),
          label: Text(
            "เพิ่มแผนใหม่", //สร้างแผนใหม่
