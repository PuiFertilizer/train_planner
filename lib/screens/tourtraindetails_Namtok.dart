...
class Tourtraindetails_Namtok extends StatefulWidget {
  ...
  @override
  State<Tourtraindetails_Namtok> createState() =>
      _Tourtraindetails_NamtokState();
}
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            Text(
                              'ถึงสะพานข้ามแม่นํ้าแคว ให้นักท่องเที่ยวชมและถ่ายภาพสะพานข้ามแม่นํ้าแควตามอัธยาศัย',
                              maxLines: 5,
                              style: GoogleFonts.prompt(
                                color: Colors.black,
                                fontSize: 12,
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            Text(
                              'ขบวนรถไฟพิเศษนำเที่ยวออกจากสะพานข้ามแม่นํ้าแคว',
                              maxLines: 5,
                              style: GoogleFonts.prompt(
                                color: Colors.black,
                                fontSize: 12,
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            Text(
                              'ถึงถำ้กระแซ ชมเส้นทางรถไฟสายประวัติศาสตร์สร้างโดยเชลย ศึกฝ่ายสัมพันธ์มิตร เป็นเส้นทางที่สวยที่สุดแห่งหนึ่ง ลัดเลาะไปตาม หน้าผาและป่าโปร่ง',
                              maxLines: 5,
                              style: GoogleFonts.prompt(
                                color: Colors.black,
                                fontSize: 12,
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            Text(
                              'ถึงนํ้าตกไทรโยคน้อย พักผ่อนเล่นนํ้าตกประมาณ3 ชั่วโมง',
                              maxLines: 5,
                              style: GoogleFonts.prompt(
                                color: Colors.black,
                                fontSize: 12,
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            Text(
                              'ออกเดินทางจากนํ้าตกไทรโยคน้อย แวะชมสุสานทหารพันธมิตร',
                              maxLines: 5,
                              style: GoogleFonts.prompt(
                                color: Colors.black,
                                fontSize: 12,
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            Text(
                              'พร้อมกันที่สถานีกาญจนบุรี เพื่อขึ้นรถไฟกลับกรุงเทพฯ',
                              maxLines: 5,
                              style: GoogleFonts.prompt(
                                color: Colors.black,
                                fontSize: 12,
                        ...
                        child: RawScrollbar(
                          ...
                          child: ListView.builder(
                              ...
                              itemBuilder: (BuildContext context, int index) {
                                NamtokSeating namtokSeating =
                                    namtokSeatings[index];
                                return Stack(
                                  children: <Widget>[
                                    Container(
                                      margin: const EdgeInsets.fromLTRB(
