...
class Tourtraindetails_Pasak extends StatefulWidget {
  ...
  @override
  State<Tourtraindetails_Pasak> createState() => _Tourtraindetails_PasakState();
}
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            Text(
                              'ขบวนรถไฟพิเศษนำเที่ยวเขื่อนป่าสักชลสิทธิ์ออกจากสถานีกรุงเทพ (หัวลำโพง)',
                              maxLines: 5,
                              style: GoogleFonts.prompt(
                                color: Colors.black,
                                fontSize: 12,
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            Text(
                              'ออกจากสถานีนถไฟหินซ้อนแล้ว จะพบทุ่งทานตะวันริมทางรถไฟสีเหลืองงดงานตลอดแนว',
                              maxLines: 5,
                              style: GoogleFonts.prompt(
                                color: Colors.black,
                                fontSize: 12,
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            Text(
                              'ถึงที่หยุดรถเขื่อนป่าสักชลสิทธิ',
                              maxLines: 5,
                              style: GoogleFonts.prompt(
                                color: Colors.black,
                                fontSize: 12,
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            Text(
                              'ขบวนรถหยุด ณ จุดชมวิวประมาณ 30 นาที ให้นักท่องเที่ยวชมทิวทัศน์ ถ่ายภาพบริเวณ เหนือเขื่อนป่าสักชลสิทธิ์ ชม “รถไฟลอยนํ้า” ',
                              maxLines: 5,
                              style: GoogleFonts.prompt(
                                color: Colors.black,
                                fontSize: 12,
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            Text(
                              'ขบวนรถถึงที่หยุดรถเขื่อนป่าสักชลสิทธิ์ รับประทานอาหารกลางวันตามอัธยาศัย หรือจะใช้บริการของรถไฟเล็กพาชมความตื่นตาตื่นใจของวิวทิวทัศน์รอบๆ จนอิ่มอกอิ่มใจ และซื้อของฝาก ของที่ระลึก ผลิตภัณฑ์ชุมชนก็ได้',
                              maxLines: 5,
                              style: GoogleFonts.prompt(
                                color: Colors.black,
                                fontSize: 12,
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            Text(
                              'ขบวนรถไฟพิเศษนำเที่ยว ออกจากที่หยุดรถเขื่อนป่าสักชลสิทธิ์',
                              maxLines: 5,
                              style: GoogleFonts.prompt(
                                color: Colors.black,
                                fontSize: 12,
