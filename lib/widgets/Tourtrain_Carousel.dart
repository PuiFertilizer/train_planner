...
class Tourtrain_Carousel extends StatelessWidget {
  const Tourtrain_Carousel({super.key});
                          ...
                          child: GestureDetector(
                            onTap: () {
                              Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                      builder: (context) =>
                                          const Tourtraindetails_Suanson()));
                            },
                            child: Container(
                              height: 140.0,
                              width: 200.0,
                          ...
                          child: GestureDetector(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                  image: const DecorationImage(
                                      image:
                                          AssetImage('assets/images/steam.jpg'),
                                      fit: BoxFit.cover),
                                  borderRadius: BorderRadius.circular(15)),
                            ),
                          ),
