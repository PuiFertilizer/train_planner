                    ...
                    children: [
                      Material(
                        ...
                        child: Theme(
                            //<-- SEE HERE
                            data:
                                ThemeData().copyWith(splashColor: Colors.white),
                            child: _tabBar),
                      ),
                    ],
                  ),
                                                              ...
                                                              Navigator.push(
                                                                ...
                                                                MaterialPageRoute(
                                                                    builder:
                                                                        (context) =>
                                                                            StationDetails(
                                                                              station: stationStopList.stationName,
                                                                            )),
                                                              );
                                                            },
                                                            child: Text(
                                      ...
                                      SingleChildScrollView(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            Image.asset(
                                              'assets/images/trainchart/trainchart_sprinter.png',
                                              height: 30,
                                            ) //ผังขบวนรถตามเลขขบวน
                                          ],
                                        ),
