...
class Tourtraindetails_Suanson extends StatefulWidget {
  ...
  @override
  _Tourtraindetails_SuansonState createState() => _Tourtraindetails_SuansonState();
}
                      ...
                      children: [
                        Container(  
                          ...
                          padding: const EdgeInsets.only(left: 20, right: 20),
                            ...
                            children: <Widget>[
                            Text(
                              '10:30 น.', style: GoogleFonts.prompt(color: Color.fromARGB(255,87,204,153),  fontSize: 16, fontWeight: FontWeight.bold ),
                            ),
                            ],
                           ),
                          ),
                        ...
                        Container(  
                          ...
                          padding: const EdgeInsets.only(left: 20, right: 20),
                            ...
                            children: <Widget>[
                            Text(
                              'ถึงสถานีหัวหิน ใครอยากเล่นนํ้าที่ชายหาดหัวหิน ก็สามารถนั่งรถสองแถวต่อไปได้',maxLines: 5, style: GoogleFonts.prompt(color: Colors.black, fontSize: 12, ),
                            ),
                            ],
                           ),
                          ),
                      ...
                      children: [
                        Container(  
                          ...
                          padding: const EdgeInsets.only(left: 20, right: 20),
                            ...
                            children: <Widget>[
                            Text(
                              '10:40 น.', style: GoogleFonts.prompt(color: Color.fromARGB(255,87,204,153),  fontSize: 16, fontWeight: FontWeight.bold ),
                            ),
                            ],
                           ),
                          ),
                        ...
                        Container(  
                          ...
                          padding: const EdgeInsets.only(left: 20, right: 20),
                            ...
                            children: <Widget>[
                            Text(
                              'ถึงที่หยุดรถสวนสนประดิพัทธ์ เดินไม่กี่ก้าวก็ถึงชายทะเลแล้ว',maxLines: 5, style: GoogleFonts.prompt(color: Colors.black, fontSize: 12, ),
                            ),
                            ],
                           ),
                          ),
                      ...
                      children: [
                        Container(  
                          ...
                          padding: const EdgeInsets.only(left: 20, right: 20),
                            ...
                            children: <Widget>[
                            Text(
                              '15:31 น.', style: GoogleFonts.prompt(color: Color.fromARGB(255,87,204,153),  fontSize: 16, fontWeight: FontWeight.bold ),
                            ),
                            ],
                           ),
                          ),
                        ...
                        Container(  
                          ...
                          padding: const EdgeInsets.only(left: 20, right: 20),
                            ...
                            children: <Widget>[
                            Text(
                              'พร้อมกันที่ที่หยุดรถสวนสนประดิพัทธ์ เพื่อขึ้นรถไฟกลับกรุงเทพ',maxLines: 5, style: GoogleFonts.prompt(color: Colors.black, fontSize: 12, ),
                            ),
                            ],
                           ),
                          ),
                      ...
                      children: [
                        Container(  
                          ...
                          padding: const EdgeInsets.only(left: 20, right: 20),
                            ...
                            children: <Widget>[
                            Text(
                              '15:39 น.', style: GoogleFonts.prompt(color: Color.fromARGB(255,87,204,153),  fontSize: 16, fontWeight: FontWeight.bold ),
                            ),
                            ],
                           ),
                          ),
                        ...
                        Container(  
                          ...
                          padding: const EdgeInsets.only(left: 20, right: 20),
                            ...
                            children: <Widget>[
                            Text(
                              'ถึงสถานีรถไฟหัวหิน', maxLines: 5, style: GoogleFonts.prompt(color: Colors.black, fontSize: 12, ),
                            ),
                            ],
                           ),
                          ),
                          ...
                          child: Container(
                            ...
                            child: ListView.builder(
                              ...
                              itemBuilder: (BuildContext context, int index) {
                                SuansonStationStopList suansonStationStopList =
              ...
              child: Padding(
                ...
                child: RawScrollbar(
                  ...
                  child: ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        SuansonSeating suansonSeating = suansonSeatings[index];
                        return Stack(
                          children: <Widget>[
                            Container(
                              margin: const EdgeInsets.fromLTRB(
                                  ...
                                  children: <Widget>[
                                    Row(
                                      ...
                                      children: <Widget>[
                                        Expanded(
                                          child: Text(
                                           suansonSeating.coachname, //ชื่อของตู้โดยสาร
                                            style: GoogleFonts.prompt(
                                              fontSize: 17,
                                              color: Colors.black,
                                              fontWeight: FontWeight.w600,
                                    ...
                                    Image(
                                      ...
                                      //width: 200.0, //200
                                      image:
                                          AssetImage(suansonSeating.imageUrlConvience),
                                      fit: BoxFit.cover,
                                    )
                                  ],
                                ),
